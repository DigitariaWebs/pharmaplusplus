...
export default function Newsletter() {
  ...
  return (
    <section id="newsletter" className="py-20 px-6 bg-gradient-to-r from-green-600 to-emerald-600 text-white scroll-mt-20">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl text-green-100 mb-10 max-w-2xl mx-auto">
          ...
          Inscrivez-vous pour être informé du lancement et bénéficier d'offres exclusives.
        </p>

        {isSubmitted ? (
          <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-8 max-w-md mx-auto animate-fade-in">
            <div className="text-5xl mb-4">✅</div>
            <h3 className="text-2xl font-semibold mb-2">Merci de votre inscription !</h3>
            <p className="text-green-100">
              Votre demande a bien été prise en compte. Nous vous contacterons avant le lancement dans votre pays.
            </p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="max-w-2xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                  <label className="block text-sm text-green-100 mb-1">Nom de la société</label>
                  <input
                    type="text"
                    value={company}
                ...
                <div>
                  <label className="block text-sm text-green-100 mb-1">Nom du responsable</label>
                  <input
                    type="text"
                    value={responsible}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div>
                  <label className="block text-sm text-green-100 mb-1">Téléphone (optionnel)</label>
        ...
        <div className="mt-16 inline-block bg-white/10 backdrop-blur-sm rounded-2xl px-8 py-4 border border-white/20">
          ...
          <p className="text-4xl font-bold tabular-nums">{displayedCount.toLocaleString('fr-FR')}</p>
          <p className="text-sm text-green-100 mt-1">personnes dans la file d'attente</p>
        </div>
      </div>
    </section>
  )
